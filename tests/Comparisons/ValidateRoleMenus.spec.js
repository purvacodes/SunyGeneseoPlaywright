...
test('Compare WP Role Menu Mapper with Drupal Groups', async ({ page }) => {
  ...
  await page.goto("https://palegoldenrod-ant-677872.hostingersite.com/wp-admin/", {
    timeout: 60000,
  ...
  await page.goto(
    'https://palegoldenrod-ant-677872.hostingersite.com/wp-admin/themes.php?page=mu-role-menu-mapper'
  );
