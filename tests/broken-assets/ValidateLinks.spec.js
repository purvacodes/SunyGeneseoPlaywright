...
test("Validate URLs and Broken Links (with retry, throttle, progress)", async () => {
  ...
  await finalFactory.utility.saveToExcel("validatedLinks.xlsx", "ValidatedUrls", results.allValidated, "url-reports");
  await finalFactory.utility.saveToExcel("brokenLinks.xlsx", "BrokenLinks", results.broken, "url-reports");
